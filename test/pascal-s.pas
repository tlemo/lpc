...
const nkw   =   27;      (* no. of key words *)
      ...
      tmax  =  1000 {100 [sam]};      (* size of table *)
      bmax  =   100 {20 [sam]};      (* size of block-table *)
      amax  =   100 {30 [sam]};      (* size of array-table *)
      c2max =   100 {20 [sam]};      (* size of real constant table *)
      csmax =   100 {30 [sam]};      (* max no. of cases *)
      cmax  =  10000 {850 [sam]};      (* size of code *)
      lmax  =    100 {7 [sam]};      (* maximum level *)
      smax  =  10000 {600 [sam]};      (* size of string table *)
      ...
      linelimit = 10000 {200 [sam]};
      stacksize = 10000 {1500 [sam]};
...
begin if cc = ll then
      begin if eof(srcfil) {[sam]} then         
         ...
         writeln; ll := ll+1; line[ll] := ' '; get(srcfil);
      end;
   cc := cc+1; ch := line[cc];
end (* nextch *);
