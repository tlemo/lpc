...
%Frame_load = type
{
    ...
    i8,    ; ch
    i32,    ; iline
    %T_load_array_39,    ; labeltab
    i32,    ; labelvalue
    %T_load_array_40,    ; word
