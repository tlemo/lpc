...
; types
%T_READER_RDRCMD_subroutine_47 = type __subroutine
...
; types
%T_READER_STACMD_STAOPT_subroutine_48 = type __subroutine
...
; types
%T_YRMOVE_NCHIN_subroutine_49 = type __subroutine
;================================================================================
; metadata
...
!0 = !DIFile(filename: "chess05ISO.pas", checksumkind: CSK_None)
...
!23 = !DISubrange(count: 17, lowerBound: 0)
!24 = !{!23}
...
!29 = TODO
!30 = !DISubrange(count: 17, lowerBound: 0)
!31 = !{!30}
...
!34 = !DISubrange(count: 13, lowerBound: 0)
!35 = !{!34}
...
!67 = TODO
!68 = !DISubrange(count: 20, lowerBound: -2)
!69 = !{!68}
...
!77 = !DISubrange(count: 8, lowerBound: 0)
!78 = !{!77}
...
!129 = !DISubrange(count: 10, lowerBound: 1)
!130 = !{!129}
...
!139 = !DISubrange(count: 500, lowerBound: 1)
!140 = !{!139}
...
!223 = !DISubrange(count: 8, lowerBound: 0)
!224 = !{!223}
!225 = !DISubrange(count: 8, lowerBound: 0)
!226 = !{!225}
...
!243 = !DISubrange(count: 6, lowerBound: 0)
!244 = !{!243}
...
!248 = !{!247}
!249 = !DISubrange(count: 6, lowerBound: 0)
!250 = !{!249}
!251 = TODO
!252 = TODO
!253 = TODO
