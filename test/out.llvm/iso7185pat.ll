...
!429 = !{}
!430 = !{}
!431 = !{!"LPC 1.1 (debug) - built on Mar 20 2020"}
!432 = distinct !DICompileUnit(language: DW_LANG_Pascal83, file: !0, producer: "LPC 1.1 (debug) - built on Mar 20 2020", isOptimized: true, runtimeVersion: 0, emissionKind: FullDebug, enums: !429, retainedTypes: !428, globals: !430, nameTableKind: None)
