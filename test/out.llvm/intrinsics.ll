...
define void @P_()
{
    ...
    call void @_WriteReal(i8* %t3, i32 0, i32 0, double %.dummy.intrin)
    ...
    call void @_WriteReal(i8* %t4, i32 0, i32 0, double %.dummy.intrin)
    ...
    call void @_WriteReal(i8* %t5, i32 0, i32 0, double %.dummy.intrin)
    ...
    call void @_WriteInteger(i8* %t6, i32 0, i32 0, i32 %.dummy.intrin)
