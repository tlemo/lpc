...
private:
    virtual VarPtr visit(ts::VoidType* pType)
    {
        auto pExt = ext(pType);
        pExt->size = 0;
        pExt->alignment = 0;
    ...
    virtual VarPtr visit(ts::IntegerType* pType)
    {
        auto pExt = ext(pType);
        pExt->size = 4;
        pExt->alignment = 4;
    ...
    virtual VarPtr visit(ts::CharType* pType)
    {
        auto pExt = ext(pType);
        pExt->size = 1;
        pExt->alignment = 1;
    ...
    virtual VarPtr visit(ts::BoolType* pType)
    {
        auto pExt = ext(pType);
        pExt->size = 1;
        pExt->alignment = 1;
    ...
    virtual VarPtr visit(ts::RealType* pType)
    {
        auto pExt = ext(pType);
        pExt->size = 8;
        pExt->alignment = 8;
    ...
    virtual VarPtr visit(ts::EnumType* pType)
    {
        auto pExt = ext(pType);
        pExt->size = 4;
        pExt->alignment = 4;
...
struct TmpExpr : public ast::Expr
{
    ...
    virtual VarPtr accept(ast::Visitor* pVisitor) const;
};
...
public:
    virtual const char* targetName() const { return "clr"; }
...
private:
    ...
    //
private:
    virtual const char* _outputExt() const { return ".il"; }
    ...
    //      <epilogue>
    //
    // where <labelN> is a label inside teh function body
    //
...
private:
    ...
    //
    virtual VarPtr visit(const ast::FieldExpr* pFieldUse)
    {
